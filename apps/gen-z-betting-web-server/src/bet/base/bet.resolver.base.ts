...
export class BetResolverBase {
  ...
  @graphql.ResolveField(() => Outcome, {
    nullable: true,
    name: "outcome",
  })
  async getOutcome(@graphql.Parent() parent: Bet): Promise<Outcome | null> {
    const result = await this.service.getOutcome(parent.id);
